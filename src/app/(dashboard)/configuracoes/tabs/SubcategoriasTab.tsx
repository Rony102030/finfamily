            ...
            <div className="space-y-3">
                {subcategorias.length === 0 ? (
                    ...
                    subcategorias.map(sub => (
                        <div key={sub.id} className="flex items-center justify-between p-4 bg-surface border border-borders rounded-xl group hover:border-brand-green/30 transition-colors">
